...
5. **توبلا (Topla):** (سيارة) أوروبي (سلوفيني).
6. **ستارتر (Starter):** (سيارة) كوري قوي.
...
- إذا سأل العميل عن بطارية سيارة، رشح له الأنواع المحلية (فولستارك، جرمن، تايجر، إلخ) أو المستوردة (بوش، فارتا، توبلا).
