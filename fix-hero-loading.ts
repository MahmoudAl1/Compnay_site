...
hero = hero.replace(
  /<div className="relative w-full bg-slate-900 overflow-hidden flex items-center justify-center">[\s\S]*?\{heroImages\.map\(\(img, index\) => \(/,
...
console.log('Fixed hero loading state');
